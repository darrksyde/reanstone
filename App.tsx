...
import SustainabilityServices from './pages/SustainabilityServices';
...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { 
      ...
      path: '#',
      children: [
        { name: 'EPPM', path: '/services/eppm' },
        { name: 'IRM', path: '/services/irm' },
        { name: 'Pipeline Integrity', path: '/services/pipeline' },
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/90 backdrop-blur-md py-4 shadow-sm' : 'bg-transparent py-6'}`}>
        <div className="max-w-[1440px] mx-auto w-full px-6 flex justify-between items-center">
          <Link to="/" className="relative z-50 flex items-center gap-2 group">
            <img src="/assets/reanstone logo.png" alt="Reanstone" className="h-10 w-auto" />
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <Button to="/contact" variant="primary" className="!px-6 !py-2 !text-xs">Contact Us</Button>
          </div>
...
const Footer = () => (
  <footer className="bg-brand-dark text-white pt-24 pb-12 px-6">
    <div className="max-w-[1440px] mx-auto w-full grid md:grid-cols-4 gap-12 border-b border-gray-800 pb-16">
      <div className="col-span-1 md:col-span-1">
        <img src="/assets/reanstone logo.png" alt="Reanstone" className="h-12 w-auto mb-6 brightness-0 invert" />
      ...
      <div>
        ...
        <ul className="space-y-3 text-gray-400 text-sm">
          ...
          <li><Link to="/services/waste-management" className="hover:text-brand-primary transition-colors">Waste Management</Link></li>
        </ul>
      </div>
    ...
    <div className="max-w-[1440px] mx-auto w-full mt-12 flex flex-col md:flex-row justify-between items-center text-gray-500 text-xs">
      ...
      <div className="min-h-screen bg-white text-brand-dark selection:bg-brand-primary selection:text-white font-sans">
        ...
        <main>
          <Routes>
            ...
            <Route path="/services/eppm" element={<EPPM />} />
            <Route path="/services/irm" element={<IRM />} />
